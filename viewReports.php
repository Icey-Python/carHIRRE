...
<html>
    ...
    <?php
    if($_SESSION['report'] == "successful and is in progress"){
    ?>
    ...
    <?php
        ...
        ?>
        <div class="container"><p class="bg-secondary font-weight-bold text-center p-2 rounded text-white">Sorry, your transaction did not go through</p></div>
        <?php
    }
    ?>
        </div>

...
<link rel="stylesheet" href="about.css">
  ...
  <body class="body1">
    <H4 class="text-dark text-center pt-5">About us</H4>
<p class="text-dark text-center d-block pt-5" style="font-size: large;">
    Regie motors is company that offers quality sevices. 
    <br>We enable people to make online car reservations. 
    <br>we expect your to fill your correct credentials before booking. 
    <br>Your details we be kept confidential so you don't have to be worried of their safety.  </p>

<h4 class="text-dark text-center pt-5">our testimonials</h4>
